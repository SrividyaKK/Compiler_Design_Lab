...
void dfs(int v)
{
	...
	for (int i = 0; i < 26; i++)
		...
		{ // transition is there from v for input symbol i, and the state transitionMap[v][i] hasn't been visited yet.
...
int main()
{
	...
	printf("Enter the transitions in the format FROM_STATE SYMBOL TO_STATE: \n");
	int from;
	char symbol;
	int to;
